# The Cliffs Native and Web Starter

Essentially the solito-expo-router-starter with some minor
modifications to suit my workflow.
...
- Expo local dev:
  ...
  - After building the dev client, from the root of the monorepo...
    - `pnpm native` (This runs `expo start --dev-client`)
